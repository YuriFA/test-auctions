...
export const AdmittedOrganizationSchema = {
  properties: {
    id: {
      type: 'integer',
      example: 14,
...
export const AuctionListItemSchema = {
  description: 'Главный Data-объект списка аукционов.',
  properties: {
    main: {
      $ref: '#/components/schemas/AuctionListItemMain',
    },
    organizer: {
      $ref: '#/components/schemas/AuctionListItemOrganizer',
    },
    route: {
      $ref: '#/components/schemas/AuctionListItemRoute',
    },
    cargo: {
      $ref: '#/components/schemas/AuctionListItemCargo',
    },
    trading: {
      $ref: '#/components/schemas/AuctionListItemTrading',
    },
    payment: {
      $ref: '#/components/schemas/AuctionListItemPayment',
    },
  },
  type: 'object',
} as const

export const AuctionListItemCargoSchema = {
  ...
  properties: {
    ...
    loading_types: {
      $ref: '#/components/schemas/AuctionListItemCargoLoadingType',
    },
    docs: {
      $ref: '#/components/schemas/AuctionListItemCargoDocs',
    },
    car: {
      oneOf: [
        {
          $ref: '#/components/schemas/AuctionListItemCargoCar',
        },
      ],
      nullable: true,
    },
...
export const AuctionListItemCargoCarSchema = {
...
export const AuctionListItemCargoDocsSchema = {
  description: 'Данные о грузе.',
  properties: {
    tir: {
      type: 'boolean',
...
export const AuctionListItemCargoLoadingTypeSchema = {
  description: 'Данные о грузе.',
  properties: {
    side: {
      type: 'boolean',
...
export const AuctionListItemMainSchema = {
...
export const AuctionListItemOrganizerSchema = {
...
export const AuctionListItemPaymentSchema = {
...
export const AuctionListItemRouteSchema = {
  description: 'Объединенный маршрут.',
  properties: {
    load: {
      $ref: '#/components/schemas/AuctionListItemRoutePoint',
    },
    unload: {
      $ref: '#/components/schemas/AuctionListItemRoutePoint',
    },
...
export const AuctionListItemRoutePointSchema = {
...
export const AuctionListItemTradingSchema = {
  ...
  properties: {
    ...
    price: {
      oneOf: [
        {
          $ref: '#/components/schemas/AuctionListItemTradingPrice',
        },
      ],
      nullable: true,
    },
    your: {
      oneOf: [
        {
          $ref: '#/components/schemas/AuctionListItemTradingYour',
        },
      ],
      nullable: true,
    },
...
export const AuctionListItemTradingPriceSchema = {
  properties: {
    start: {
      type: 'number',
      format: 'float',
...
export const AuctionListItemTradingYourSchema = {
  properties: {
    bet: {
...
export const AuctionListMetaSchema = {
...
export const AuctionListRequestSchema = {
...
export const AuctionListResponseBaseSchema = {
  ...
  properties: {
    data: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/AuctionListItem',
      },
    },
    meta: {
      $ref: '#/components/schemas/AuctionListMeta',
    },
  },
  type: 'object',
} as const

export const AuctionShowCargoSchema = {
  properties: {
    price: {
    ...
    loading_types: {
      $ref: '#/components/schemas/LoadingTypes',
    },
    docs: {
      $ref: '#/components/schemas/Docs',
    },
    car: {
      $ref: '#/components/schemas/CarRequirements',
    },
  },
  type: 'object',
} as const

export const AuctionShowMainSchema = {
  properties: {
    id: {
      type: 'integer',
      example: 1236,
...
export const AuctionShowOrganizerSchema = {
  properties: {
    subscriber_id: {
      type: 'integer',
      example: 98,
...
export const AuctionShowPaymentSchema = {
  properties: {
    condition: {
      type: 'string',
    ...
    delay_type: {
      $ref: '#/components/schemas/PaymentDelayType',
    },
    currency_code: {
      description: 'Код валюты (ISO 4217 numeric)',
      type: 'string',
...
export const AuctionShowResponseSchema = {
  required: [
    'main',
    'organizer',
    'contacts',
  ...
  properties: {
    main: {
      $ref: '#/components/schemas/AuctionShowMain',
    },
    organizer: {
      $ref: '#/components/schemas/AuctionShowOrganizer',
    },
    contacts: {
    ...
    cargo: {
      $ref: '#/components/schemas/AuctionShowCargo',
    },
    trading: {
      $ref: '#/components/schemas/AuctionShowTrading',
    },
    payment: {
      $ref: '#/components/schemas/AuctionShowPayment',
    },
    assembly: {
    ...
    admitted_organizations: {
      ...
      type: 'array',
      items: {
        $ref: '#/components/schemas/AdmittedOrganization',
      },
    },
    hide_bets_history: {
      type: 'boolean',
...
export const AuctionShowTradingSchema = {
  properties: {
    status: {
    ...
    bid_measurement_type: {
      $ref: '#/components/schemas/BidMeasurementType',
    },
    can_set_bet: {
      type: 'boolean',
      example: false,
    ...
    price: {
      $ref: '#/components/schemas/AuctionShowTradingPrice',
    },
    your: {
      $ref: '#/components/schemas/AuctionShowTradingYour',
    },
    settings: {
      $ref: '#/components/schemas/AuctionShowTradingSettings',
    },
  },
  type: 'object',
} as const

export const AuctionShowTradingPriceSchema = {
  properties: {
    start: {
      type: 'number',
      format: 'float',
...
export const AuctionShowTradingSettingsSchema = {
  properties: {
    prolong_after_bet: {
...
export const AuctionShowTradingYourSchema = {
  properties: {
    bet: {
      type: 'boolean',
      example: false,
...
export const AuctionStatusSchema = {
  description:
    'Статус аукциона:\n- `Planning` — планирование (1)\n- `Auction` — торги идут (2)\n- `DeterminateWinner` — определение победителя (3)\n- `WaitDeal` — ожидание сделки (4)\n- `InProgress` — в работе (5)\n- `Finished` — завершён (6)\n- `Stopped` — остановлен (7)\n- `Canceled` — отменён (8)\n- `Unknown` — неизвестный статус',
  type: 'string',
  example: 'Auction',
...
export const AuctionTypeSchema = {
  description:
    'Тип аукциона:\n- `Request` — заявочный (1)\n- `Up` — на повышение (2)\n- `Down` — на понижение (3)\n- `FixPrice` — фиксированная цена (4)\n- `Unknown` — неизвестный тип',
  type: 'string',
  example: 'Down',
...
export const BetItemSchema = {
  properties: {
    ...
    price_info: {
      $ref: '#/components/schemas/BetItemPriceInfo',
    },
  },
  type: 'object',
} as const

export const BetItemPriceInfoSchema = {
  properties: {
    price_with_vat: {
      type: 'number',
      format: 'float',
...
export const BetListResponseSchema = {
  required: ['bets'],
  properties: {
    bets: {
      type: 'array',
...
export const BidMeasurementTypeSchema = {
  description:
    'Единица измерения ставки:\n- `PerRoute` — за рейс (0)\n- `PerKm` — за км (1)\n- `Unknown` — неизвестный тип',
  type: 'string',
  example: 'PerRoute',
...
export const CarRequirementsSchema = {
  description: 'Требования к ТС; null если не заданы',
  properties: {
    type: {
      type: 'string',
...
export const LoadingTypesSchema = {
  properties: {
    side: {
      type: 'boolean',
      example: false,
...
export const PaymentDelayTypeSchema = {
  description:
...
export const RoutePointSchema = {
  properties: {
    ...
    location: {
      $ref: '#/components/schemas/RoutePointLocation',
    },
    cargo: {
      $ref: '#/components/schemas/RoutePointCargo',
    },
    contact: {
      $ref: '#/components/schemas/RoutePointContact',
    },
  },
  type: 'object',
} as const

export const RoutePointCargoSchema = {
  properties: {
    name: {
      type: 'string',
      example: 'Мороженое',
...
export const RoutePointContactSchema = {
  properties: {
    name: {
      type: 'string',
      example: '',
...
export const RoutePointLocationSchema = {
  properties: {
    city_name: {
      type: 'string',
      example: 'Пермь',
...
export const SetBetRequestSchema = {
  required: ['price'],
  properties: {
    price: {
...
export const ValidationProblemSchema = {
  ...
  required: ['code', 'title', 'message', 'errors'],
  properties: {
    code: {
      type: 'string',
