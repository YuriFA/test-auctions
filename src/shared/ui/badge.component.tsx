  ...
  'group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-full border border-transparent px-2 py-0.5 text-[0.625rem] font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 [&>svg]:pointer-events-none [&>svg]:size-2.5!',
  {
    variants: {
      variant: {
        ...
        success:
          'bg-success/10 text-success-foreground focus-visible:ring-success/20 [a]:hover:bg-success/20',
        info: 'bg-info/10 text-info-foreground focus-visible:ring-info/20 [a]:hover:bg-info/20',
        warning:
          'bg-warning/10 text-warning-foreground focus-visible:ring-warning/20 [a]:hover:bg-warning/20',
        outline:
